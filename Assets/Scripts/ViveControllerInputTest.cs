...
public class ViveControllerInputTest : MonoBehaviour {
    ...
    // A reference to the object being tracked. In this case, 
    // a controller.
    ...
    // Once this script is loaded, the trackedObj gets a reference to the 
    // SteamVR_TrackedObject component that’s attached to the controllers:

    // Update is called once per frame
    void Update () {

        // 1 Get the position of the finger when it's on the touchpad
